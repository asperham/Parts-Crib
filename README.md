...
# Production Testing
To test the viability of production for this unit, you can see what the total cost, and total time it takes to produce this product. For me, it took about 3 months working on it once a week with a total cost of about $50 since I had most of the required materials. Realistically, this project can be compleated in a couple of days if you work on some of the steps at the same time such as doing testing and printing the case and making the PCB at the same time. Also, once the code is finalized, you can just upload it to each new unit reducing the total time of the project. This whole unit is not to hard to replicate and it rather easy to construct.   
